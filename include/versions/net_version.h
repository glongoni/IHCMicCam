/*
 * Revisão do último commit desta lib/entidade: 2425
 * Data do último commit desta lib/entidade: 2010/08/31 17:25:28
 * Range do último commit: 2549
 * URL: https://143.54.132.132/svn/iva/branches/v1.6.x/src/net
 * Data de geração deste arquivo: 2010/11/18 12:42:52
 */
...
#define SW_VERSION_REV          2425             ///< Versão SVN
#define SW_VERSION_TYPE         dev               ///< Tipo do release: "dev" quando versão em desenvolvimento
#define SW_VERSION_STR_4        "1.5.6b.2425-dev"     ///< String com nome inteiro da versão
